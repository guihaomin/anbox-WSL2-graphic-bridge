...
size_t gles1_decoder_context_t::decode(void *buf, size_t len, IOStream *stream)
{
	...
	while ((len - pos >= 8) && !unknownOpcode) {   
		...
		case OP_glAlphaFunc: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4, ptr + 8 + 4 + 4, checksumSize, 
					"8 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glAlphaFunc(0x%08x %f )", stream,var_func, var_ref);
		...
		case OP_glClearColor: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glClearColor(%f %f %f %f )", stream,var_red, var_green, var_blue, var_alpha);
		...
		case OP_glClearDepthf: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4, ptr + 8 + 4, checksumSize, 
					"8 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glClearDepthf(%f )", stream,var_depth);
		...
		case OP_glClipPlanef: {
			...
			uint32_t size_equation  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4);
			InputBuffer inptr_equation(ptr + 8 + 4 + 4, size_equation);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_equation, ptr + 8 + 4 + 4 + size_equation, checksumSize, 
					"8 + 4 + 4 + size_equation::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glClipPlanef(0x%08x %p(%u) )", stream,var_plane, (const GLfloat*)(inptr_equation.get()), size_equation);
		...
		case OP_glColor4f: {
			...
			DEBUG("gles1(%p): glColor4f(%f %f %f %f )", stream,var_red, var_green, var_blue, var_alpha);
		...
		case OP_glDepthRangef: {
			...
			DEBUG("gles1(%p): glDepthRangef(%f %f )", stream,var_zNear, var_zFar);
		...
		case OP_glFogf: {
			...
			DEBUG("gles1(%p): glFogf(0x%08x %f )", stream,var_pname, var_param);
		...
		case OP_glFogfv: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_params, ptr + 8 + 4 + 4 + size_params, checksumSize, 
					"8 + 4 + 4 + size_params::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glFogfv(0x%08x %p(%u) )", stream,var_pname, (const GLfloat*)(inptr_params.get()), size_params);
		...
		case OP_glFrustumf: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glFrustumf(%f %f %f %f %f %f )", stream,var_left, var_right, var_bottom, var_top, var_zNear, var_zFar);
		...
		case OP_glGetClipPlanef: {
			GLenum var_pname = Unpack<GLenum,uint32_t>(ptr + 8);
			uint32_t size_eqn  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4, ptr + 8 + 4 + 4, checksumSize, 
					"8 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glGetClipPlanef(0x%08x %p(%u) )", stream,var_pname, (GLfloat*)(outptr_eqn.get()), size_eqn);
		...
		case OP_glGetFloatv: {
			...
			DEBUG("gles1(%p): glGetFloatv(0x%08x %p(%u) )", stream,var_pname, (GLfloat*)(outptr_params.get()), size_params);
		...
		case OP_glGetLightfv: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			size_t totalTmpSize = size_params;
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetLightfv(0x%08x 0x%08x %p(%u) )", stream,var_light, var_pname, (GLfloat*)(outptr_params.get()), size_params);
		...
		case OP_glGetMaterialfv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetMaterialfv(0x%08x 0x%08x %p(%u) )", stream,var_face, var_pname, (GLfloat*)(outptr_params.get()), size_params);
		...
		case OP_glGetTexEnvfv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetTexEnvfv(0x%08x 0x%08x %p(%u) )", stream,var_env, var_pname, (GLfloat*)(outptr_params.get()), size_params);
		...
		case OP_glGetTexParameterfv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetTexParameterfv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (GLfloat*)(outptr_params.get()), size_params);
		...
		case OP_glLightModelf: {
			...
			DEBUG("gles1(%p): glLightModelf(0x%08x %f )", stream,var_pname, var_param);
		...
		case OP_glLightModelfv: {
			...
			DEBUG("gles1(%p): glLightModelfv(0x%08x %p(%u) )", stream,var_pname, (const GLfloat*)(inptr_params.get()), size_params);
		...
		case OP_glLightf: {
			...
			DEBUG("gles1(%p): glLightf(0x%08x 0x%08x %f )", stream,var_light, var_pname, var_param);
		...
		case OP_glLightfv: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + size_params, ptr + 8 + 4 + 4 + 4 + size_params, checksumSize, 
					"8 + 4 + 4 + 4 + size_params::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glLightfv(0x%08x 0x%08x %p(%u) )", stream,var_light, var_pname, (const GLfloat*)(inptr_params.get()), size_params);
		...
		case OP_glLineWidth: {
			...
			DEBUG("gles1(%p): glLineWidth(%f )", stream,var_width);
			this->glLineWidth(var_width);
			SET_LASTCALL("glLineWidth");
			break;
		}
		case OP_glLoadMatrixf: {
			uint32_t size_m  = Unpack<uint32_t,uint32_t>(ptr + 8);
			InputBuffer inptr_m(ptr + 8 + 4, size_m);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + size_m, ptr + 8 + 4 + size_m, checksumSize, 
					"8 + 4 + size_m::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glLoadMatrixf(%p(%u) )", stream,(const GLfloat*)(inptr_m.get()), size_m);
		...
		case OP_glMaterialf: {
			...
			DEBUG("gles1(%p): glMaterialf(0x%08x 0x%08x %f )", stream,var_face, var_pname, var_param);
		...
		case OP_glMaterialfv: {
			...
			DEBUG("gles1(%p): glMaterialfv(0x%08x 0x%08x %p(%u) )", stream,var_face, var_pname, (const GLfloat*)(inptr_params.get()), size_params);
		...
		case OP_glMultMatrixf: {
			...
			DEBUG("gles1(%p): glMultMatrixf(%p(%u) )", stream,(const GLfloat*)(inptr_m.get()), size_m);
		...
		case OP_glMultiTexCoord4f: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glMultiTexCoord4f(0x%08x %f %f %f %f )", stream,var_target, var_s, var_t, var_r, var_q);
		...
		case OP_glNormal3f: {
			...
			DEBUG("gles1(%p): glNormal3f(%f %f %f )", stream,var_nx, var_ny, var_nz);
		...
		case OP_glOrthof: {
			...
			DEBUG("gles1(%p): glOrthof(%f %f %f %f %f %f )", stream,var_left, var_right, var_bottom, var_top, var_zNear, var_zFar);
		...
		case OP_glPointParameterf: {
			...
			DEBUG("gles1(%p): glPointParameterf(0x%08x %f )", stream,var_pname, var_param);
		...
		case OP_glPointParameterfv: {
			...
			DEBUG("gles1(%p): glPointParameterfv(0x%08x %p(%u) )", stream,var_pname, (const GLfloat*)(inptr_params.get()), size_params);
		...
		case OP_glPointSize: {
			...
			DEBUG("gles1(%p): glPointSize(%f )", stream,var_size);
		...
		case OP_glPolygonOffset: {
			...
			DEBUG("gles1(%p): glPolygonOffset(%f %f )", stream,var_factor, var_units);
		...
		case OP_glRotatef: {
			...
			DEBUG("gles1(%p): glRotatef(%f %f %f %f )", stream,var_angle, var_x, var_y, var_z);
		...
		case OP_glScalef: {
			...
			DEBUG("gles1(%p): glScalef(%f %f %f )", stream,var_x, var_y, var_z);
		...
		case OP_glTexEnvf: {
			...
			DEBUG("gles1(%p): glTexEnvf(0x%08x 0x%08x %f )", stream,var_target, var_pname, var_param);
		...
		case OP_glTexEnvfv: {
			...
			DEBUG("gles1(%p): glTexEnvfv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (const GLfloat*)(inptr_params.get()), size_params);
		...
		case OP_glTexParameterf: {
			...
			DEBUG("gles1(%p): glTexParameterf(0x%08x 0x%08x %f )", stream,var_target, var_pname, var_param);
		...
		case OP_glTexParameterfv: {
			...
			DEBUG("gles1(%p): glTexParameterfv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (const GLfloat*)(inptr_params.get()), size_params);
		...
		case OP_glTranslatef: {
			...
			DEBUG("gles1(%p): glTranslatef(%f %f %f )", stream,var_x, var_y, var_z);
		...
		case OP_glActiveTexture: {
			...
			DEBUG("gles1(%p): glActiveTexture(0x%08x )", stream,var_texture);
		...
		case OP_glAlphaFuncx: {
			...
			DEBUG("gles1(%p): glAlphaFuncx(0x%08x 0x%08x )", stream,var_func, var_ref);
		...
		case OP_glBindBuffer: {
			...
			DEBUG("gles1(%p): glBindBuffer(0x%08x %u )", stream,var_target, var_buffer);
		...
		case OP_glBindTexture: {
			...
			DEBUG("gles1(%p): glBindTexture(0x%08x %u )", stream,var_target, var_texture);
		...
		case OP_glBlendFunc: {
			...
			DEBUG("gles1(%p): glBlendFunc(0x%08x 0x%08x )", stream,var_sfactor, var_dfactor);
		...
		case OP_glBufferData: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + size_data + 4, ptr + 8 + 4 + 4 + 4 + size_data + 4, checksumSize, 
					"8 + 4 + 4 + 4 + size_data + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glBufferData(0x%08x %p %p(%u) 0x%08x )", stream,var_target, var_size, (const GLvoid*)(inptr_data.get()), size_data, var_usage);
		...
		case OP_glBufferSubData: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + size_data, ptr + 8 + 4 + 4 + 4 + 4 + size_data, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + size_data::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glBufferSubData(0x%08x %p %p %p(%u) )", stream,var_target, var_offset, var_size, (const GLvoid*)(inptr_data.get()), size_data);
		...
		case OP_glClear: {
			...
			DEBUG("gles1(%p): glClear(0x%08x )", stream,var_mask);
		...
		case OP_glClearColorx: {
			...
			DEBUG("gles1(%p): glClearColorx(0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_red, var_green, var_blue, var_alpha);
		...
		case OP_glClearDepthx: {
			...
			DEBUG("gles1(%p): glClearDepthx(0x%08x )", stream,var_depth);
		...
		case OP_glClearStencil: {
			...
			DEBUG("gles1(%p): glClearStencil(%d )", stream,var_s);
		...
		case OP_glClientActiveTexture: {
			...
			DEBUG("gles1(%p): glClientActiveTexture(0x%08x )", stream,var_texture);
		...
		case OP_glColor4ub: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 1 + 1 + 1 + 1, ptr + 8 + 1 + 1 + 1 + 1, checksumSize, 
					"8 + 1 + 1 + 1 + 1::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glColor4ub(0x%02x 0x%02x 0x%02x 0x%02x )", stream,var_red, var_green, var_blue, var_alpha);
		...
		case OP_glColor4x: {
			...
			DEBUG("gles1(%p): glColor4x(0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_red, var_green, var_blue, var_alpha);
		...
		case OP_glColorMask: {
			...
			DEBUG("gles1(%p): glColorMask(%d %d %d %d )", stream,var_red, var_green, var_blue, var_alpha);
		...
		case OP_glColorPointer: {
			...
			uint32_t size_pointer  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4 + 4);
			InputBuffer inptr_pointer(ptr + 8 + 4 + 4 + 4 + 4, size_pointer);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + size_pointer, ptr + 8 + 4 + 4 + 4 + 4 + size_pointer, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + size_pointer::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glColorPointer(%d 0x%08x %d %p(%u) )", stream,var_size, var_type, var_stride, (const GLvoid*)(inptr_pointer.get()), size_pointer);
		...
		case OP_glCompressedTexImage2D: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + size_data, ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + size_data, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + size_data::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glCompressedTexImage2D(0x%08x %d 0x%08x %d %d %d %d %p(%u) )", stream,var_target, var_level, var_internalformat, var_width, var_height, var_border, var_imageSize, (const GLvoid*)(inptr_data.get()), size_data);
		...
		case OP_glCompressedTexSubImage2D: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + size_data, ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + size_data, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + size_data::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glCompressedTexSubImage2D(0x%08x %d %d %d %d %d 0x%08x %d %p(%u) )", stream,var_target, var_level, var_xoffset, var_yoffset, var_width, var_height, var_format, var_imageSize, (const GLvoid*)(inptr_data.get()), size_data);
		...
		case OP_glCopyTexImage2D: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glCopyTexImage2D(0x%08x %d 0x%08x %d %d %d %d %d )", stream,var_target, var_level, var_internalformat, var_x, var_y, var_width, var_height, var_border);
		...
		case OP_glCopyTexSubImage2D: {
			...
			DEBUG("gles1(%p): glCopyTexSubImage2D(0x%08x %d %d %d %d %d %d %d )", stream,var_target, var_level, var_xoffset, var_yoffset, var_x, var_y, var_width, var_height);
		...
		case OP_glCullFace: {
			...
			DEBUG("gles1(%p): glCullFace(0x%08x )", stream,var_mode);
		...
		case OP_glDeleteBuffers: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_buffers, ptr + 8 + 4 + 4 + size_buffers, checksumSize, 
					"8 + 4 + 4 + size_buffers::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDeleteBuffers(%d %p(%u) )", stream,var_n, (const GLuint*)(inptr_buffers.get()), size_buffers);
		...
		case OP_glDeleteTextures: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_textures, ptr + 8 + 4 + 4 + size_textures, checksumSize, 
					"8 + 4 + 4 + size_textures::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDeleteTextures(%d %p(%u) )", stream,var_n, (const GLuint*)(inptr_textures.get()), size_textures);
		...
		case OP_glDepthFunc: {
			...
			DEBUG("gles1(%p): glDepthFunc(0x%08x )", stream,var_func);
		...
		case OP_glDepthMask: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 1, ptr + 8 + 1, checksumSize, 
					"8 + 1::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDepthMask(%d )", stream,var_flag);
		...
		case OP_glDepthRangex: {
			...
			DEBUG("gles1(%p): glDepthRangex(0x%08x 0x%08x )", stream,var_zNear, var_zFar);
		...
		case OP_glDisable: {
			...
			DEBUG("gles1(%p): glDisable(0x%08x )", stream,var_cap);
		...
		case OP_glDisableClientState: {
			...
			DEBUG("gles1(%p): glDisableClientState(0x%08x )", stream,var_array);
		...
		case OP_glDrawArrays: {
			...
			DEBUG("gles1(%p): glDrawArrays(0x%08x %d %d )", stream,var_mode, var_first, var_count);
		...
		case OP_glDrawElements: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + size_indices, ptr + 8 + 4 + 4 + 4 + 4 + size_indices, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + size_indices::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDrawElements(0x%08x %d 0x%08x %p(%u) )", stream,var_mode, var_count, var_type, (const GLvoid*)(inptr_indices.get()), size_indices);
		...
		case OP_glEnable: {
			...
			DEBUG("gles1(%p): glEnable(0x%08x )", stream,var_cap);
		...
		case OP_glEnableClientState: {
			...
			DEBUG("gles1(%p): glEnableClientState(0x%08x )", stream,var_array);
		...
		case OP_glFinish: {
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8, ptr + 8, checksumSize, 
					"8::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glFinish()", stream);
			this->glFinish();
		...
		case OP_glFogx: {
			...
			DEBUG("gles1(%p): glFogx(0x%08x 0x%08x )", stream,var_pname, var_param);
		...
		case OP_glFogxv: {
			...
			DEBUG("gles1(%p): glFogxv(0x%08x %p(%u) )", stream,var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glFrontFace: {
			...
			DEBUG("gles1(%p): glFrontFace(0x%08x )", stream,var_mode);
		...
		case OP_glFrustumx: {
			...
			DEBUG("gles1(%p): glFrustumx(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_left, var_right, var_bottom, var_top, var_zNear, var_zFar);
		...
		case OP_glGetBooleanv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetBooleanv(0x%08x %p(%u) )", stream,var_pname, (GLboolean*)(outptr_params.get()), size_params);
		...
		case OP_glGetBufferParameteriv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetBufferParameteriv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (GLint*)(outptr_params.get()), size_params);
		...
		case OP_glClipPlanex: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_eqn, ptr + 8 + 4 + 4 + size_eqn, checksumSize, 
					"8 + 4 + 4 + size_eqn::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glClipPlanex(0x%08x %p(%u) )", stream,var_pname, (const GLfixed*)(inptr_eqn.get()), size_eqn);
		...
		case OP_glGenBuffers: {
			...
			DEBUG("gles1(%p): glGenBuffers(%d %p(%u) )", stream,var_n, (GLuint*)(outptr_buffers.get()), size_buffers);
		...
		case OP_glGenTextures: {
			...
			DEBUG("gles1(%p): glGenTextures(%d %p(%u) )", stream,var_n, (GLuint*)(outptr_textures.get()), size_textures);
		...
		case OP_glGetError: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glGetError()", stream);
		...
		case OP_glGetFixedv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetFixedv(0x%08x %p(%u) )", stream,var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glGetIntegerv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetIntegerv(0x%08x %p(%u) )", stream,var_pname, (GLint*)(outptr_params.get()), size_params);
		...
		case OP_glGetLightxv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetLightxv(0x%08x 0x%08x %p(%u) )", stream,var_light, var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glGetMaterialxv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetMaterialxv(0x%08x 0x%08x %p(%u) )", stream,var_face, var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glGetPointerv: {
			...
			DEBUG("gles1(%p): glGetPointerv(0x%08x %p(%u) )", stream,var_pname, (GLvoid**)(inptr_params.get()), size_params);
		...
		case OP_glGetString: {
			...
			DEBUG("gles1(%p): glGetString(0x%08x )", stream,var_name);
		...
		case OP_glGetTexEnviv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetTexEnviv(0x%08x 0x%08x %p(%u) )", stream,var_env, var_pname, (GLint*)(outptr_params.get()), size_params);
		...
		case OP_glGetTexEnvxv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetTexEnvxv(0x%08x 0x%08x %p(%u) )", stream,var_env, var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glGetTexParameteriv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetTexParameteriv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (GLint*)(outptr_params.get()), size_params);
		...
		case OP_glGetTexParameterxv: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetTexParameterxv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glHint: {
			...
			DEBUG("gles1(%p): glHint(0x%08x 0x%08x )", stream,var_target, var_mode);
		...
		case OP_glIsBuffer: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glIsBuffer(%u )", stream,var_buffer);
		...
		case OP_glIsEnabled: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glIsEnabled(0x%08x )", stream,var_cap);
		...
		case OP_glIsTexture: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glIsTexture(%u )", stream,var_texture);
		...
		case OP_glLightModelx: {
			...
			DEBUG("gles1(%p): glLightModelx(0x%08x 0x%08x )", stream,var_pname, var_param);
		...
		case OP_glLightModelxv: {
			...
			DEBUG("gles1(%p): glLightModelxv(0x%08x %p(%u) )", stream,var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glLightx: {
			...
			DEBUG("gles1(%p): glLightx(0x%08x 0x%08x 0x%08x )", stream,var_light, var_pname, var_param);
		...
		case OP_glLightxv: {
			...
			DEBUG("gles1(%p): glLightxv(0x%08x 0x%08x %p(%u) )", stream,var_light, var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glLineWidthx: {
			...
			DEBUG("gles1(%p): glLineWidthx(0x%08x )", stream,var_width);
		...
		case OP_glLoadIdentity: {
			...
			DEBUG("gles1(%p): glLoadIdentity()", stream);
			this->glLoadIdentity();
		...
		case OP_glLoadMatrixx: {
			...
			DEBUG("gles1(%p): glLoadMatrixx(%p(%u) )", stream,(const GLfixed*)(inptr_m.get()), size_m);
		...
		case OP_glLogicOp: {
			...
			DEBUG("gles1(%p): glLogicOp(0x%08x )", stream,var_opcode);
		...
		case OP_glMaterialx: {
			...
			DEBUG("gles1(%p): glMaterialx(0x%08x 0x%08x 0x%08x )", stream,var_face, var_pname, var_param);
		...
		case OP_glMaterialxv: {
			...
			DEBUG("gles1(%p): glMaterialxv(0x%08x 0x%08x %p(%u) )", stream,var_face, var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glMatrixMode: {
			...
			DEBUG("gles1(%p): glMatrixMode(0x%08x )", stream,var_mode);
		...
		case OP_glMultMatrixx: {
			...
			DEBUG("gles1(%p): glMultMatrixx(%p(%u) )", stream,(const GLfixed*)(inptr_m.get()), size_m);
		...
		case OP_glMultiTexCoord4x: {
			...
			DEBUG("gles1(%p): glMultiTexCoord4x(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_target, var_s, var_t, var_r, var_q);
		...
		case OP_glNormal3x: {
			...
			DEBUG("gles1(%p): glNormal3x(0x%08x 0x%08x 0x%08x )", stream,var_nx, var_ny, var_nz);
		...
		case OP_glNormalPointer: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + size_pointer, ptr + 8 + 4 + 4 + 4 + size_pointer, checksumSize, 
					"8 + 4 + 4 + 4 + size_pointer::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glNormalPointer(0x%08x %d %p(%u) )", stream,var_type, var_stride, (const GLvoid*)(inptr_pointer.get()), size_pointer);
		...
		case OP_glOrthox: {
			...
			DEBUG("gles1(%p): glOrthox(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_left, var_right, var_bottom, var_top, var_zNear, var_zFar);
		...
		case OP_glPixelStorei: {
			...
			DEBUG("gles1(%p): glPixelStorei(0x%08x %d )", stream,var_pname, var_param);
		...
		case OP_glPointParameterx: {
			...
			DEBUG("gles1(%p): glPointParameterx(0x%08x 0x%08x )", stream,var_pname, var_param);
		...
		case OP_glPointParameterxv: {
			...
			DEBUG("gles1(%p): glPointParameterxv(0x%08x %p(%u) )", stream,var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glPointSizex: {
			...
			DEBUG("gles1(%p): glPointSizex(0x%08x )", stream,var_size);
		...
		case OP_glPolygonOffsetx: {
			...
			DEBUG("gles1(%p): glPolygonOffsetx(0x%08x 0x%08x )", stream,var_factor, var_units);
		...
		case OP_glPopMatrix: {
			...
			DEBUG("gles1(%p): glPopMatrix()", stream);
			this->glPopMatrix();
		...
		case OP_glPushMatrix: {
			...
			DEBUG("gles1(%p): glPushMatrix()", stream);
			this->glPushMatrix();
		...
		case OP_glReadPixels: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			size_t totalTmpSize = size_pixels;
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_pixels(&tmpBuf[0], size_pixels);
			DEBUG("gles1(%p): glReadPixels(%d %d %d %d 0x%08x 0x%08x %p(%u) )", stream,var_x, var_y, var_width, var_height, var_format, var_type, (GLvoid*)(outptr_pixels.get()), size_pixels);
		...
		case OP_glRotatex: {
			...
			DEBUG("gles1(%p): glRotatex(0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_angle, var_x, var_y, var_z);
		...
		case OP_glSampleCoverage: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 1, ptr + 8 + 4 + 1, checksumSize, 
					"8 + 4 + 1::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glSampleCoverage(%f %d )", stream,var_value, var_invert);
		...
		case OP_glSampleCoveragex: {
			...
			DEBUG("gles1(%p): glSampleCoveragex(0x%08x %d )", stream,var_value, var_invert);
		...
		case OP_glScalex: {
			...
			DEBUG("gles1(%p): glScalex(0x%08x 0x%08x 0x%08x )", stream,var_x, var_y, var_z);
		...
		case OP_glScissor: {
			...
			DEBUG("gles1(%p): glScissor(%d %d %d %d )", stream,var_x, var_y, var_width, var_height);
		...
		case OP_glShadeModel: {
			...
			DEBUG("gles1(%p): glShadeModel(0x%08x )", stream,var_mode);
		...
		case OP_glStencilFunc: {
			...
			DEBUG("gles1(%p): glStencilFunc(0x%08x %d %u )", stream,var_func, var_ref, var_mask);
		...
		case OP_glStencilMask: {
			...
			DEBUG("gles1(%p): glStencilMask(%u )", stream,var_mask);
		...
		case OP_glStencilOp: {
			...
			DEBUG("gles1(%p): glStencilOp(0x%08x 0x%08x 0x%08x )", stream,var_fail, var_zfail, var_zpass);
		...
		case OP_glTexCoordPointer: {
			...
			DEBUG("gles1(%p): glTexCoordPointer(%d 0x%08x %d %p(%u) )", stream,var_size, var_type, var_stride, (const GLvoid*)(inptr_pointer.get()), size_pointer);
		...
		case OP_glTexEnvi: {
			...
			DEBUG("gles1(%p): glTexEnvi(0x%08x 0x%08x %d )", stream,var_target, var_pname, var_param);
		...
		case OP_glTexEnvx: {
			...
			DEBUG("gles1(%p): glTexEnvx(0x%08x 0x%08x 0x%08x )", stream,var_target, var_pname, var_param);
		...
		case OP_glTexEnviv: {
			...
			DEBUG("gles1(%p): glTexEnviv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (const GLint*)(inptr_params.get()), size_params);
		...
		case OP_glTexEnvxv: {
			...
			DEBUG("gles1(%p): glTexEnvxv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glTexImage2D: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + size_pixels, ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + size_pixels, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + size_pixels::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glTexImage2D(0x%08x %d %d %d %d %d 0x%08x 0x%08x %p(%u) )", stream,var_target, var_level, var_internalformat, var_width, var_height, var_border, var_format, var_type, (const GLvoid*)(inptr_pixels.get()), size_pixels);
		...
		case OP_glTexParameteri: {
			...
			DEBUG("gles1(%p): glTexParameteri(0x%08x 0x%08x %d )", stream,var_target, var_pname, var_param);
		...
		case OP_glTexParameterx: {
			...
			DEBUG("gles1(%p): glTexParameterx(0x%08x 0x%08x 0x%08x )", stream,var_target, var_pname, var_param);
		...
		case OP_glTexParameteriv: {
			...
			DEBUG("gles1(%p): glTexParameteriv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (const GLint*)(inptr_params.get()), size_params);
		...
		case OP_glTexParameterxv: {
			...
			DEBUG("gles1(%p): glTexParameterxv(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glTexSubImage2D: {
			...
			DEBUG("gles1(%p): glTexSubImage2D(0x%08x %d %d %d %d %d 0x%08x 0x%08x %p(%u) )", stream,var_target, var_level, var_xoffset, var_yoffset, var_width, var_height, var_format, var_type, (const GLvoid*)(inptr_pixels.get()), size_pixels);
		...
		case OP_glTranslatex: {
			...
			DEBUG("gles1(%p): glTranslatex(0x%08x 0x%08x 0x%08x )", stream,var_x, var_y, var_z);
		...
		case OP_glVertexPointer: {
			...
			DEBUG("gles1(%p): glVertexPointer(%d 0x%08x %d %p(%u) )", stream,var_size, var_type, var_stride, (const GLvoid*)(inptr_pointer.get()), size_pointer);
		...
		case OP_glViewport: {
			...
			DEBUG("gles1(%p): glViewport(%d %d %d %d )", stream,var_x, var_y, var_width, var_height);
		...
		case OP_glPointSizePointerOES: {
			...
			DEBUG("gles1(%p): glPointSizePointerOES(0x%08x %d %p(%u) )", stream,var_type, var_stride, (const GLvoid*)(inptr_pointer.get()), size_pointer);
		...
		case OP_glVertexPointerOffset: {
			...
			DEBUG("gles1(%p): glVertexPointerOffset(%d 0x%08x %d %u )", stream,var_size, var_type, var_stride, var_offset);
		...
		case OP_glColorPointerOffset: {
			...
			DEBUG("gles1(%p): glColorPointerOffset(%d 0x%08x %d %u )", stream,var_size, var_type, var_stride, var_offset);
		...
		case OP_glNormalPointerOffset: {
			...
			DEBUG("gles1(%p): glNormalPointerOffset(0x%08x %d %u )", stream,var_type, var_stride, var_offset);
		...
		case OP_glPointSizePointerOffset: {
			...
			DEBUG("gles1(%p): glPointSizePointerOffset(0x%08x %d %u )", stream,var_type, var_stride, var_offset);
		...
		case OP_glTexCoordPointerOffset: {
			...
			DEBUG("gles1(%p): glTexCoordPointerOffset(%d 0x%08x %d %u )", stream,var_size, var_type, var_stride, var_offset);
		...
		case OP_glWeightPointerOffset: {
			...
			DEBUG("gles1(%p): glWeightPointerOffset(%d 0x%08x %d %u )", stream,var_size, var_type, var_stride, var_offset);
		...
		case OP_glMatrixIndexPointerOffset: {
			...
			DEBUG("gles1(%p): glMatrixIndexPointerOffset(%d 0x%08x %d %u )", stream,var_size, var_type, var_stride, var_offset);
		...
		case OP_glVertexPointerData: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + size_data + 4, ptr + 8 + 4 + 4 + 4 + 4 + size_data + 4, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + size_data + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glVertexPointerData(%d 0x%08x %d %p(%u) %u )", stream,var_size, var_type, var_stride, (void*)(inptr_data.get()), size_data, var_datalen);
		...
		case OP_glColorPointerData: {
			...
			DEBUG("gles1(%p): glColorPointerData(%d 0x%08x %d %p(%u) %u )", stream,var_size, var_type, var_stride, (void*)(inptr_data.get()), size_data, var_datalen);
		...
		case OP_glNormalPointerData: {
			...
			DEBUG("gles1(%p): glNormalPointerData(0x%08x %d %p(%u) %u )", stream,var_type, var_stride, (void*)(inptr_data.get()), size_data, var_datalen);
		...
		case OP_glTexCoordPointerData: {
			...
			uint32_t size_data  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4 + 4 + 4);
			InputBuffer inptr_data(ptr + 8 + 4 + 4 + 4 + 4 + 4, size_data);
			GLuint var_datalen = Unpack<GLuint,uint32_t>(ptr + 8 + 4 + 4 + 4 + 4 + 4 + size_data);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + 4 + size_data + 4, ptr + 8 + 4 + 4 + 4 + 4 + 4 + size_data + 4, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + 4 + size_data + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glTexCoordPointerData(%d %d 0x%08x %d %p(%u) %u )", stream,var_unit, var_size, var_type, var_stride, (void*)(inptr_data.get()), size_data, var_datalen);
		...
		case OP_glPointSizePointerData: {
			...
			DEBUG("gles1(%p): glPointSizePointerData(0x%08x %d %p(%u) %u )", stream,var_type, var_stride, (void*)(inptr_data.get()), size_data, var_datalen);
		...
		case OP_glWeightPointerData: {
			...
			DEBUG("gles1(%p): glWeightPointerData(%d 0x%08x %d %p(%u) %u )", stream,var_size, var_type, var_stride, (void*)(inptr_data.get()), size_data, var_datalen);
		...
		case OP_glMatrixIndexPointerData: {
			...
			DEBUG("gles1(%p): glMatrixIndexPointerData(%d 0x%08x %d %p(%u) %u )", stream,var_size, var_type, var_stride, (void*)(inptr_data.get()), size_data, var_datalen);
		...
		case OP_glDrawElementsOffset: {
			...
			DEBUG("gles1(%p): glDrawElementsOffset(0x%08x %d 0x%08x %u )", stream,var_mode, var_count, var_type, var_offset);
		...
		case OP_glDrawElementsData: {
			...
			DEBUG("gles1(%p): glDrawElementsData(0x%08x %d 0x%08x %p(%u) %u )", stream,var_mode, var_count, var_type, (void*)(inptr_data.get()), size_data, var_datalen);
		...
		case OP_glGetCompressedTextureFormats: {
			...
			DEBUG("gles1(%p): glGetCompressedTextureFormats(%d %p(%u) )", stream,var_count, (GLint*)(outptr_formats.get()), size_formats);
		...
		case OP_glFinishRoundTrip: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glFinishRoundTrip()", stream);
		...
		case OP_glBlendEquationSeparateOES: {
			...
			DEBUG("gles1(%p): glBlendEquationSeparateOES(0x%08x 0x%08x )", stream,var_modeRGB, var_modeAlpha);
		...
		case OP_glBlendFuncSeparateOES: {
			...
			DEBUG("gles1(%p): glBlendFuncSeparateOES(0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_srcRGB, var_dstRGB, var_srcAlpha, var_dstAlpha);
		...
		case OP_glBlendEquationOES: {
			...
			DEBUG("gles1(%p): glBlendEquationOES(0x%08x )", stream,var_mode);
		...
		case OP_glDrawTexsOES: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 2 + 2 + 2 + 2 + 2, ptr + 8 + 2 + 2 + 2 + 2 + 2, checksumSize, 
					"8 + 2 + 2 + 2 + 2 + 2::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDrawTexsOES(%d %d %d %d %d )", stream,var_x, var_y, var_z, var_width, var_height);
		...
		case OP_glDrawTexiOES: {
			...
			DEBUG("gles1(%p): glDrawTexiOES(%d %d %d %d %d )", stream,var_x, var_y, var_z, var_width, var_height);
		...
		case OP_glDrawTexxOES: {
			...
			DEBUG("gles1(%p): glDrawTexxOES(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_x, var_y, var_z, var_width, var_height);
			this->glDrawTexxOES(var_x, var_y, var_z, var_width, var_height);
			SET_LASTCALL("glDrawTexxOES");
			break;
		}
		case OP_glDrawTexsvOES: {
			uint32_t size_coords  = Unpack<uint32_t,uint32_t>(ptr + 8);
			InputBuffer inptr_coords(ptr + 8 + 4, size_coords);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + size_coords, ptr + 8 + 4 + size_coords, checksumSize, 
					"8 + 4 + size_coords::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDrawTexsvOES(%p(%u) )", stream,(const GLshort*)(inptr_coords.get()), size_coords);
		...
		case OP_glDrawTexivOES: {
			...
			DEBUG("gles1(%p): glDrawTexivOES(%p(%u) )", stream,(const GLint*)(inptr_coords.get()), size_coords);
		...
		case OP_glDrawTexxvOES: {
			...
			DEBUG("gles1(%p): glDrawTexxvOES(%p(%u) )", stream,(const GLfixed*)(inptr_coords.get()), size_coords);
		...
		case OP_glDrawTexfOES: {
			...
			DEBUG("gles1(%p): glDrawTexfOES(%f %f %f %f %f )", stream,var_x, var_y, var_z, var_width, var_height);
		...
		case OP_glDrawTexfvOES: {
			...
			DEBUG("gles1(%p): glDrawTexfvOES(%p(%u) )", stream,(const GLfloat*)(inptr_coords.get()), size_coords);
		...
		case OP_glEGLImageTargetTexture2DOES: {
			...
			DEBUG("gles1(%p): glEGLImageTargetTexture2DOES(0x%08x %p )", stream,var_target, var_image);
		...
		case OP_glEGLImageTargetRenderbufferStorageOES: {
			...
			DEBUG("gles1(%p): glEGLImageTargetRenderbufferStorageOES(0x%08x %p )", stream,var_target, var_image);
		...
		case OP_glAlphaFuncxOES: {
			...
			DEBUG("gles1(%p): glAlphaFuncxOES(0x%08x 0x%08x )", stream,var_func, var_ref);
		...
		case OP_glClearColorxOES: {
			...
			DEBUG("gles1(%p): glClearColorxOES(0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_red, var_green, var_blue, var_alpha);
		...
		case OP_glClearDepthxOES: {
			...
			DEBUG("gles1(%p): glClearDepthxOES(0x%08x )", stream,var_depth);
		...
		case OP_glClipPlanexOES: {
			...
			DEBUG("gles1(%p): glClipPlanexOES(0x%08x %p(%u) )", stream,var_plane, (const GLfixed*)(inptr_equation.get()), size_equation);
		...
		case OP_glClipPlanexIMG: {
			...
			DEBUG("gles1(%p): glClipPlanexIMG(0x%08x %p(%u) )", stream,var_plane, (const GLfixed*)(inptr_equation.get()), size_equation);
		...
		case OP_glColor4xOES: {
			...
			DEBUG("gles1(%p): glColor4xOES(0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_red, var_green, var_blue, var_alpha);
		...
		case OP_glDepthRangexOES: {
			...
			DEBUG("gles1(%p): glDepthRangexOES(0x%08x 0x%08x )", stream,var_zNear, var_zFar);
		...
		case OP_glFogxOES: {
			...
			DEBUG("gles1(%p): glFogxOES(0x%08x 0x%08x )", stream,var_pname, var_param);
		...
		case OP_glFogxvOES: {
			...
			DEBUG("gles1(%p): glFogxvOES(0x%08x %p(%u) )", stream,var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glFrustumxOES: {
			...
			DEBUG("gles1(%p): glFrustumxOES(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_left, var_right, var_bottom, var_top, var_zNear, var_zFar);
		...
		case OP_glGetClipPlanexOES: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_eqn(&tmpBuf[0], size_eqn);
			DEBUG("gles1(%p): glGetClipPlanexOES(0x%08x %p(%u) )", stream,var_pname, (GLfixed*)(outptr_eqn.get()), size_eqn);
		...
		case OP_glGetClipPlanex: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_eqn(&tmpBuf[0], size_eqn);
			DEBUG("gles1(%p): glGetClipPlanex(0x%08x %p(%u) )", stream,var_pname, (GLfixed*)(outptr_eqn.get()), size_eqn);
		...
		case OP_glGetFixedvOES: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetFixedvOES(0x%08x %p(%u) )", stream,var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glGetLightxvOES: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetLightxvOES(0x%08x 0x%08x %p(%u) )", stream,var_light, var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glGetMaterialxvOES: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetMaterialxvOES(0x%08x 0x%08x %p(%u) )", stream,var_face, var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glGetTexEnvxvOES: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetTexEnvxvOES(0x%08x 0x%08x %p(%u) )", stream,var_env, var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glGetTexParameterxvOES: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetTexParameterxvOES(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (GLfixed*)(outptr_params.get()), size_params);
		...
		case OP_glLightModelxOES: {
			...
			DEBUG("gles1(%p): glLightModelxOES(0x%08x 0x%08x )", stream,var_pname, var_param);
		...
		case OP_glLightModelxvOES: {
			...
			DEBUG("gles1(%p): glLightModelxvOES(0x%08x %p(%u) )", stream,var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glLightxOES: {
			...
			DEBUG("gles1(%p): glLightxOES(0x%08x 0x%08x 0x%08x )", stream,var_light, var_pname, var_param);
		...
		case OP_glLightxvOES: {
			...
			DEBUG("gles1(%p): glLightxvOES(0x%08x 0x%08x %p(%u) )", stream,var_light, var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glLineWidthxOES: {
			...
			DEBUG("gles1(%p): glLineWidthxOES(0x%08x )", stream,var_width);
		...
		case OP_glLoadMatrixxOES: {
			...
			DEBUG("gles1(%p): glLoadMatrixxOES(%p(%u) )", stream,(const GLfixed*)(inptr_m.get()), size_m);
		...
		case OP_glMaterialxOES: {
			...
			DEBUG("gles1(%p): glMaterialxOES(0x%08x 0x%08x 0x%08x )", stream,var_face, var_pname, var_param);
		...
		case OP_glMaterialxvOES: {
			...
			DEBUG("gles1(%p): glMaterialxvOES(0x%08x 0x%08x %p(%u) )", stream,var_face, var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glMultMatrixxOES: {
			...
			DEBUG("gles1(%p): glMultMatrixxOES(%p(%u) )", stream,(const GLfixed*)(inptr_m.get()), size_m);
		...
		case OP_glMultiTexCoord4xOES: {
			...
			DEBUG("gles1(%p): glMultiTexCoord4xOES(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_target, var_s, var_t, var_r, var_q);
		...
		case OP_glNormal3xOES: {
			...
			DEBUG("gles1(%p): glNormal3xOES(0x%08x 0x%08x 0x%08x )", stream,var_nx, var_ny, var_nz);
		...
		case OP_glOrthoxOES: {
			...
			DEBUG("gles1(%p): glOrthoxOES(0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_left, var_right, var_bottom, var_top, var_zNear, var_zFar);
		...
		case OP_glPointParameterxOES: {
			...
			DEBUG("gles1(%p): glPointParameterxOES(0x%08x 0x%08x )", stream,var_pname, var_param);
		...
		case OP_glPointParameterxvOES: {
			...
			DEBUG("gles1(%p): glPointParameterxvOES(0x%08x %p(%u) )", stream,var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glPointSizexOES: {
			...
			DEBUG("gles1(%p): glPointSizexOES(0x%08x )", stream,var_size);
		...
		case OP_glPolygonOffsetxOES: {
			...
			DEBUG("gles1(%p): glPolygonOffsetxOES(0x%08x 0x%08x )", stream,var_factor, var_units);
		...
		case OP_glRotatexOES: {
			...
			DEBUG("gles1(%p): glRotatexOES(0x%08x 0x%08x 0x%08x 0x%08x )", stream,var_angle, var_x, var_y, var_z);
		...
		case OP_glSampleCoveragexOES: {
			...
			DEBUG("gles1(%p): glSampleCoveragexOES(0x%08x %d )", stream,var_value, var_invert);
		...
		case OP_glScalexOES: {
			...
			DEBUG("gles1(%p): glScalexOES(0x%08x 0x%08x 0x%08x )", stream,var_x, var_y, var_z);
		...
		case OP_glTexEnvxOES: {
			...
			DEBUG("gles1(%p): glTexEnvxOES(0x%08x 0x%08x 0x%08x )", stream,var_target, var_pname, var_param);
		...
		case OP_glTexEnvxvOES: {
			...
			DEBUG("gles1(%p): glTexEnvxvOES(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glTexParameterxOES: {
			...
			DEBUG("gles1(%p): glTexParameterxOES(0x%08x 0x%08x 0x%08x )", stream,var_target, var_pname, var_param);
		...
		case OP_glTexParameterxvOES: {
			...
			DEBUG("gles1(%p): glTexParameterxvOES(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glTranslatexOES: {
			...
			DEBUG("gles1(%p): glTranslatexOES(0x%08x 0x%08x 0x%08x )", stream,var_x, var_y, var_z);
		...
		case OP_glIsRenderbufferOES: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glIsRenderbufferOES(%u )", stream,var_renderbuffer);
		...
		case OP_glBindRenderbufferOES: {
			...
			DEBUG("gles1(%p): glBindRenderbufferOES(0x%08x %u )", stream,var_target, var_renderbuffer);
		...
		case OP_glDeleteRenderbuffersOES: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_renderbuffers, ptr + 8 + 4 + 4 + size_renderbuffers, checksumSize, 
					"8 + 4 + 4 + size_renderbuffers::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDeleteRenderbuffersOES(%d %p(%u) )", stream,var_n, (const GLuint*)(inptr_renderbuffers.get()), size_renderbuffers);
		...
		case OP_glGenRenderbuffersOES: {
			...
			DEBUG("gles1(%p): glGenRenderbuffersOES(%d %p(%u) )", stream,var_n, (GLuint*)(outptr_renderbuffers.get()), size_renderbuffers);
		...
		case OP_glRenderbufferStorageOES: {
			...
			DEBUG("gles1(%p): glRenderbufferStorageOES(0x%08x 0x%08x %d %d )", stream,var_target, var_internalformat, var_width, var_height);
		...
		case OP_glGetRenderbufferParameterivOES: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetRenderbufferParameterivOES(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (GLint*)(outptr_params.get()), size_params);
		...
		case OP_glIsFramebufferOES: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glIsFramebufferOES(%u )", stream,var_framebuffer);
		...
		case OP_glBindFramebufferOES: {
			...
			DEBUG("gles1(%p): glBindFramebufferOES(0x%08x %u )", stream,var_target, var_framebuffer);
		...
		case OP_glDeleteFramebuffersOES: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_framebuffers, ptr + 8 + 4 + 4 + size_framebuffers, checksumSize, 
					"8 + 4 + 4 + size_framebuffers::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDeleteFramebuffersOES(%d %p(%u) )", stream,var_n, (const GLuint*)(inptr_framebuffers.get()), size_framebuffers);
		...
		case OP_glGenFramebuffersOES: {
			...
			DEBUG("gles1(%p): glGenFramebuffersOES(%d %p(%u) )", stream,var_n, (GLuint*)(outptr_framebuffers.get()), size_framebuffers);
		...
		case OP_glCheckFramebufferStatusOES: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glCheckFramebufferStatusOES(0x%08x )", stream,var_target);
		...
		case OP_glFramebufferRenderbufferOES: {
			...
			DEBUG("gles1(%p): glFramebufferRenderbufferOES(0x%08x 0x%08x 0x%08x %u )", stream,var_target, var_attachment, var_renderbuffertarget, var_renderbuffer);
		...
		case OP_glFramebufferTexture2DOES: {
			...
			DEBUG("gles1(%p): glFramebufferTexture2DOES(0x%08x 0x%08x 0x%08x %u %d )", stream,var_target, var_attachment, var_textarget, var_texture, var_level);
		...
		case OP_glGetFramebufferAttachmentParameterivOES: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetFramebufferAttachmentParameterivOES(0x%08x 0x%08x 0x%08x %p(%u) )", stream,var_target, var_attachment, var_pname, (GLint*)(outptr_params.get()), size_params);
		...
		case OP_glGenerateMipmapOES: {
			...
			DEBUG("gles1(%p): glGenerateMipmapOES(0x%08x )", stream,var_target);
		...
		case OP_glMapBufferOES: {
			...
			DEBUG("gles1(%p): glMapBufferOES(0x%08x 0x%08x )", stream,var_target, var_access);
		...
		case OP_glUnmapBufferOES: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glUnmapBufferOES(0x%08x )", stream,var_target);
		...
		case OP_glGetBufferPointervOES: {
			...
			DEBUG("gles1(%p): glGetBufferPointervOES(0x%08x 0x%08x %p(%u) )", stream,var_target, var_pname, (GLvoid**)(inptr_params.get()), size_params);
		...
		case OP_glCurrentPaletteMatrixOES: {
			...
			DEBUG("gles1(%p): glCurrentPaletteMatrixOES(%u )", stream,var_matrixpaletteindex);
		...
		case OP_glLoadPaletteFromModelViewMatrixOES: {
			...
			DEBUG("gles1(%p): glLoadPaletteFromModelViewMatrixOES()", stream);
		...
		case OP_glMatrixIndexPointerOES: {
			...
			DEBUG("gles1(%p): glMatrixIndexPointerOES(%d 0x%08x %d %p(%u) )", stream,var_size, var_type, var_stride, (const GLvoid*)(inptr_pointer.get()), size_pointer);
		...
		case OP_glWeightPointerOES: {
			...
			DEBUG("gles1(%p): glWeightPointerOES(%d 0x%08x %d %p(%u) )", stream,var_size, var_type, var_stride, (const GLvoid*)(inptr_pointer.get()), size_pointer);
		...
		case OP_glQueryMatrixxOES: {
			uint32_t size_mantissa  = Unpack<uint32_t,uint32_t>(ptr + 8);
			uint32_t size_exponent  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4, ptr + 8 + 4 + 4, checksumSize, 
					"8 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glQueryMatrixxOES(%p(%u) %p(%u) )", stream,(GLfixed*)(outptr_mantissa.get()), size_mantissa, (GLint*)(outptr_exponent.get()), size_exponent);
		...
		case OP_glDepthRangefOES: {
			...
			DEBUG("gles1(%p): glDepthRangefOES(%f %f )", stream,var_zNear, var_zFar);
		...
		case OP_glFrustumfOES: {
			...
			DEBUG("gles1(%p): glFrustumfOES(%f %f %f %f %f %f )", stream,var_left, var_right, var_bottom, var_top, var_zNear, var_zFar);
		...
		case OP_glOrthofOES: {
			...
			DEBUG("gles1(%p): glOrthofOES(%f %f %f %f %f %f )", stream,var_left, var_right, var_bottom, var_top, var_zNear, var_zFar);
		...
		case OP_glClipPlanefOES: {
			...
			DEBUG("gles1(%p): glClipPlanefOES(0x%08x %p(%u) )", stream,var_plane, (const GLfloat*)(inptr_equation.get()), size_equation);
		...
		case OP_glClipPlanefIMG: {
			...
			DEBUG("gles1(%p): glClipPlanefIMG(0x%08x %p(%u) )", stream,var_plane, (const GLfloat*)(inptr_equation.get()), size_equation);
		...
		case OP_glGetClipPlanefOES: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_eqn(&tmpBuf[0], size_eqn);
			DEBUG("gles1(%p): glGetClipPlanefOES(0x%08x %p(%u) )", stream,var_pname, (GLfloat*)(outptr_eqn.get()), size_eqn);
		...
		case OP_glClearDepthfOES: {
			...
			DEBUG("gles1(%p): glClearDepthfOES(%f )", stream,var_depth);
		...
		case OP_glTexGenfOES: {
			...
			DEBUG("gles1(%p): glTexGenfOES(0x%08x 0x%08x %f )", stream,var_coord, var_pname, var_param);
		...
		case OP_glTexGenfvOES: {
			...
			DEBUG("gles1(%p): glTexGenfvOES(0x%08x 0x%08x %p(%u) )", stream,var_coord, var_pname, (const GLfloat*)(inptr_params.get()), size_params);
		...
		case OP_glTexGeniOES: {
			...
			DEBUG("gles1(%p): glTexGeniOES(0x%08x 0x%08x %d )", stream,var_coord, var_pname, var_param);
		...
		case OP_glTexGenivOES: {
			...
			DEBUG("gles1(%p): glTexGenivOES(0x%08x 0x%08x %p(%u) )", stream,var_coord, var_pname, (const GLint*)(inptr_params.get()), size_params);
		...
		case OP_glTexGenxOES: {
			...
			DEBUG("gles1(%p): glTexGenxOES(0x%08x 0x%08x 0x%08x )", stream,var_coord, var_pname, var_param);
		...
		case OP_glTexGenxvOES: {
			...
			DEBUG("gles1(%p): glTexGenxvOES(0x%08x 0x%08x %p(%u) )", stream,var_coord, var_pname, (const GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glGetTexGenfvOES: {
			...
			DEBUG("gles1(%p): glGetTexGenfvOES(0x%08x 0x%08x %p(%u) )", stream,var_coord, var_pname, (GLfloat*)(inptr_params.get()), size_params);
		...
		case OP_glGetTexGenivOES: {
			...
			DEBUG("gles1(%p): glGetTexGenivOES(0x%08x 0x%08x %p(%u) )", stream,var_coord, var_pname, (GLint*)(inptr_params.get()), size_params);
		...
		case OP_glGetTexGenxvOES: {
			...
			DEBUG("gles1(%p): glGetTexGenxvOES(0x%08x 0x%08x %p(%u) )", stream,var_coord, var_pname, (GLfixed*)(inptr_params.get()), size_params);
		...
		case OP_glBindVertexArrayOES: {
			...
			DEBUG("gles1(%p): glBindVertexArrayOES(%u )", stream,var_array);
		...
		case OP_glDeleteVertexArraysOES: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_arrays, ptr + 8 + 4 + 4 + size_arrays, checksumSize, 
					"8 + 4 + 4 + size_arrays::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDeleteVertexArraysOES(%d %p(%u) )", stream,var_n, (const GLuint*)(inptr_arrays.get()), size_arrays);
		...
		case OP_glGenVertexArraysOES: {
			...
			DEBUG("gles1(%p): glGenVertexArraysOES(%d %p(%u) )", stream,var_n, (GLuint*)(outptr_arrays.get()), size_arrays);
		...
		case OP_glIsVertexArrayOES: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glIsVertexArrayOES(%u )", stream,var_array);
		...
		case OP_glDiscardFramebufferEXT: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + size_attachments, ptr + 8 + 4 + 4 + 4 + size_attachments, checksumSize, 
					"8 + 4 + 4 + 4 + size_attachments::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDiscardFramebufferEXT(0x%08x %d %p(%u) )", stream,var_target, var_numAttachments, (const GLenum*)(inptr_attachments.get()), size_attachments);
		...
		case OP_glMultiDrawArraysEXT: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_first + 4 + size_count + 4, ptr + 8 + 4 + 4 + size_first + 4 + size_count + 4, checksumSize, 
					"8 + 4 + 4 + size_first + 4 + size_count + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glMultiDrawArraysEXT(0x%08x %p(%u) %p(%u) %d )", stream,var_mode, (const GLint*)(inptr_first.get()), size_first, (const GLsizei*)(inptr_count.get()), size_count, var_primcount);
		...
		case OP_glMultiDrawElementsEXT: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_count + 4 + 4 + size_indices + 4, ptr + 8 + 4 + 4 + size_count + 4 + 4 + size_indices + 4, checksumSize, 
					"8 + 4 + 4 + size_count + 4 + 4 + size_indices + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glMultiDrawElementsEXT(0x%08x %p(%u) 0x%08x %p(%u) %d )", stream,var_mode, (const GLsizei*)(inptr_count.get()), size_count, var_type, (const GLvoid* const*)(inptr_indices.get()), size_indices, var_primcount);
		...
		case OP_glMultiDrawArraysSUN: {
			...
			DEBUG("gles1(%p): glMultiDrawArraysSUN(0x%08x %p(%u) %p(%u) %d )", stream,var_mode, (GLint*)(inptr_first.get()), size_first, (GLsizei*)(inptr_count.get()), size_count, var_primcount);
		...
		case OP_glMultiDrawElementsSUN: {
			...
			DEBUG("gles1(%p): glMultiDrawElementsSUN(0x%08x %p(%u) 0x%08x %p(%u) %d )", stream,var_mode, (const GLsizei*)(inptr_count.get()), size_count, var_type, (const GLvoid**)(inptr_indices.get()), size_indices, var_primcount);
		...
		case OP_glRenderbufferStorageMultisampleIMG: {
			...
			DEBUG("gles1(%p): glRenderbufferStorageMultisampleIMG(0x%08x %d 0x%08x %d %d )", stream,var_target, var_samples, var_internalformat, var_width, var_height);
		...
		case OP_glFramebufferTexture2DMultisampleIMG: {
			...
			DEBUG("gles1(%p): glFramebufferTexture2DMultisampleIMG(0x%08x 0x%08x 0x%08x %u %d %d )", stream,var_target, var_attachment, var_textarget, var_texture, var_level, var_samples);
		...
		case OP_glDeleteFencesNV: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + size_fences, ptr + 8 + 4 + 4 + size_fences, checksumSize, 
					"8 + 4 + 4 + size_fences::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glDeleteFencesNV(%d %p(%u) )", stream,var_n, (const GLuint*)(inptr_fences.get()), size_fences);
		...
		case OP_glGenFencesNV: {
			...
			DEBUG("gles1(%p): glGenFencesNV(%d %p(%u) )", stream,var_n, (GLuint*)(inptr_fences.get()), size_fences);
		...
		case OP_glIsFenceNV: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glIsFenceNV(%u )", stream,var_fence);
		...
		case OP_glTestFenceNV: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glTestFenceNV(%u )", stream,var_fence);
		...
		case OP_glGetFenceivNV: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glGetFenceivNV(%u 0x%08x %p(%u) )", stream,var_fence, var_pname, (GLint*)(outptr_params.get()), size_params);
		...
		case OP_glFinishFenceNV: {
			...
			DEBUG("gles1(%p): glFinishFenceNV(%u )", stream,var_fence);
		...
		case OP_glSetFenceNV: {
			...
			DEBUG("gles1(%p): glSetFenceNV(%u 0x%08x )", stream,var_fence, var_condition);
		...
		case OP_glGetDriverControlsQCOM: {
			...
			uint32_t size_driverControls  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glGetDriverControlsQCOM(%p(%u) %d %p(%u) )", stream,(GLint*)(outptr_num.get()), size_num, var_size, (GLuint*)(outptr_driverControls.get()), size_driverControls);
		...
		case OP_glGetDriverControlStringQCOM: {
			...
			uint32_t size_driverControlString  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glGetDriverControlStringQCOM(%u %d %p(%u) %p(%u) )", stream,var_driverControl, var_bufSize, (GLsizei*)(outptr_length.get()), size_length, (GLchar*)(outptr_driverControlString.get()), size_driverControlString);
		...
		case OP_glEnableDriverControlQCOM: {
			...
			DEBUG("gles1(%p): glEnableDriverControlQCOM(%u )", stream,var_driverControl);
		...
		case OP_glDisableDriverControlQCOM: {
			...
			DEBUG("gles1(%p): glDisableDriverControlQCOM(%u )", stream,var_driverControl);
		...
		case OP_glExtGetTexturesQCOM: {
			...
			uint32_t size_numTextures  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glExtGetTexturesQCOM(%p(%u) %d %p(%u) )", stream,(GLuint*)(outptr_textures.get()), size_textures, var_maxTextures, (GLint*)(outptr_numTextures.get()), size_numTextures);
		...
		case OP_glExtGetBuffersQCOM: {
			...
			uint32_t size_numBuffers  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glExtGetBuffersQCOM(%p(%u) %d %p(%u) )", stream,(GLuint*)(outptr_buffers.get()), size_buffers, var_maxBuffers, (GLint*)(outptr_numBuffers.get()), size_numBuffers);
		...
		case OP_glExtGetRenderbuffersQCOM: {
			...
			uint32_t size_numRenderbuffers  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glExtGetRenderbuffersQCOM(%p(%u) %d %p(%u) )", stream,(GLuint*)(outptr_renderbuffers.get()), size_renderbuffers, var_maxRenderbuffers, (GLint*)(outptr_numRenderbuffers.get()), size_numRenderbuffers);
		...
		case OP_glExtGetFramebuffersQCOM: {
			...
			uint32_t size_numFramebuffers  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glExtGetFramebuffersQCOM(%p(%u) %d %p(%u) )", stream,(GLuint*)(outptr_framebuffers.get()), size_framebuffers, var_maxFramebuffers, (GLint*)(outptr_numFramebuffers.get()), size_numFramebuffers);
		...
		case OP_glExtGetTexLevelParameterivQCOM: {
			...
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_params(&tmpBuf[0], size_params);
			DEBUG("gles1(%p): glExtGetTexLevelParameterivQCOM(%u 0x%08x %d 0x%08x %p(%u) )", stream,var_texture, var_face, var_level, var_pname, (GLint*)(outptr_params.get()), size_params);
		...
		case OP_glExtTexObjectStateOverrideiQCOM: {
			...
			DEBUG("gles1(%p): glExtTexObjectStateOverrideiQCOM(0x%08x 0x%08x %d )", stream,var_target, var_pname, var_param);
		...
		case OP_glExtGetTexSubImageQCOM: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			size_t totalTmpSize = size_texels;
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			OutputBuffer outptr_texels(&tmpBuf[0], size_texels);
			DEBUG("gles1(%p): glExtGetTexSubImageQCOM(0x%08x %d %d %d %d %d %d %d 0x%08x 0x%08x %p(%u) )", stream,var_target, var_level, var_xoffset, var_yoffset, var_zoffset, var_width, var_height, var_depth, var_format, var_type, (GLvoid*)(outptr_texels.get()), size_texels);
		...
		case OP_glExtGetBufferPointervQCOM: {
			...
			DEBUG("gles1(%p): glExtGetBufferPointervQCOM(0x%08x %p(%u) )", stream,var_target, (GLvoid**)(inptr_params.get()), size_params);
		...
		case OP_glExtGetShadersQCOM: {
			...
			uint32_t size_numShaders  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glExtGetShadersQCOM(%p(%u) %d %p(%u) )", stream,(GLuint*)(outptr_shaders.get()), size_shaders, var_maxShaders, (GLint*)(outptr_numShaders.get()), size_numShaders);
		...
		case OP_glExtGetProgramsQCOM: {
			...
			uint32_t size_numPrograms  = Unpack<uint32_t,uint32_t>(ptr + 8 + 4 + 4);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4, ptr + 8 + 4 + 4 + 4, checksumSize, 
					"8 + 4 + 4 + 4::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			...
			DEBUG("gles1(%p): glExtGetProgramsQCOM(%p(%u) %d %p(%u) )", stream,(GLuint*)(outptr_programs.get()), size_programs, var_maxPrograms, (GLint*)(outptr_numPrograms.get()), size_numPrograms);
		...
		case OP_glExtIsProgramBinaryQCOM: {
			...
			totalTmpSize += checksumSize;
			unsigned char *tmpBuf = stream->alloc(totalTmpSize);
			DEBUG("gles1(%p): glExtIsProgramBinaryQCOM(%u )", stream,var_program);
		...
		case OP_glExtGetProgramBinarySourceQCOM: {
			...
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::validOrDie(ptr, 8 + 4 + 4 + 4 + size_source + 4 + size_length, ptr + 8 + 4 + 4 + 4 + size_source + 4 + size_length, checksumSize, 
					"8 + 4 + 4 + 4 + size_source + 4 + size_length::decode, OP_gles1_decoder_context_t: GL checksumCalculator failure\n");
			}
			DEBUG("gles1(%p): glExtGetProgramBinarySourceQCOM(%u 0x%08x %p(%u) %p(%u) )", stream,var_program, var_shadertype, (GLchar*)(inptr_source.get()), size_source, (GLint*)(inptr_length.get()), size_length);
		...
		case OP_glStartTilingQCOM: {
			...
			DEBUG("gles1(%p): glStartTilingQCOM(%u %u %u %u 0x%08x )", stream,var_x, var_y, var_width, var_height, var_preserveMask);
		...
		case OP_glEndTilingQCOM: {
			...
			DEBUG("gles1(%p): glEndTilingQCOM(0x%08x )", stream,var_preserveMask);
