...
class SystemConfiguration {
 public:
  ...
  std::string container_ip_address() const;
  unsigned short int container_port() const;
  unsigned short qemu_port() const;
  unsigned short anbox_bridge_port() const;
  std::string session_manager_ip_address() const;
