...
std::string anbox::SystemConfiguration::container_ip_address() const {
  static std::string path = "172.21.133.131";
  return path;
}


unsigned short int anbox::SystemConfiguration::container_port() const {
  static unsigned short port = 8080;
  return port;
}

unsigned short anbox::SystemConfiguration::qemu_port() const {
  static unsigned short port = 80;
  return port;
}

unsigned short anbox::SystemConfiguration::anbox_bridge_port() const {
  static unsigned short port = 8081;
  return port;
}

std::string anbox::SystemConfiguration::session_manager_ip_address() const {
  static std::string path = "172.22.224.1";
  return path;
}
...
std::string anbox::SystemConfiguration::input_device_dir() const {
  ...
  static std::string dir = "/home/haomin/sockets/input";
  return dir;
}
