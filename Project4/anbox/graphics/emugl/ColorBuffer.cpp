...
bool ColorBuffer::blitFromCurrentReadBuffer() {
  ...
  if (tInfo->currContext->isGL2()) {
    ...
    /*s_gles2.glTexImage2D(GL_TEXTURE_2D, 0, 6408, 1, 1,
        0, 6408, GL_UNSIGNED_BYTE, NULL);
    ...
    s_gles1.glCopyTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, 0, 0, m_width,
                                m_height);
    /*s_gles1.glTexImage2D(GL_TEXTURE_2D, 0, 6408, 1, 1,
        0, 6408, GL_UNSIGNED_BYTE, NULL);
    ...
    s_gles1.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
    s_gles1.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);*/
